...
<h2><center>Add Students in a course with a faculty - choose course</center></h2>
<table width="755">
	<tr>
...
?>
	      ...
	      <tr bgcolor="<?php echo $color?>">
		    ...
		    <td><a href="?tag=tagging2&course_id=<?php echo $row['course_id'];?>" title="Choose">Choose</a></td>
