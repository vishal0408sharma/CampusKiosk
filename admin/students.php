...
<?php
	...
	if($operation=="del")
	{
		$del_sql=mysql_query("DELETE FROM student WHERE enroll='$id' ");
...
<table width="755">
	<tr>
        ...
        <td>
        	<a href="?tag=student_entry"><input type="button" title="Add new student" name="addNew" value="Add New" id="button-search" /></a>
        </td>
        <td>
...
?>
		    ...
		    <td><?php echo $row2['type_of_dis'];?></td>
                    ...
                    <td><a href="?tag=student_entry&operation=upd&student_id=<?php echo $row['enroll'];?>" title="Update"><img src="image/update.png" /></a></td>
		    <td><a href="?tag=students&operation=del&student_id=<?php echo $row['enroll'];?>" title="Delete"><img src="image/delete.png" /></a></td>
