...
<?php
	...
	if($operation=="del")
	{
		$del_sql=mysql_query("DELETE FROM teacher WHERE id='$id' ");
...
<table width="755">
	<tr>
        ...
        <td>
        	<a href="?tag=faculty_entry"><input type="button" title="Add new Teacher" name="addNew" value="Add New" id="button-search" /></a>
        </td>
        <td>
...
?>
	      ...
	      <tr bgcolor="<?php echo $color?>">
		    ...
		    <td><a href="?tag=faculty_entry&operation=upd&faculty_id=<?php echo $row['id'];?>" title="Update"><img src="image/update.png" /></a></td>
		    <td><a href="?tag=faculty&operation=del&faculty_id=<?php echo $row['id'];?>" title="Delete"><img src="image/delete.png" /></a></td>
