...
$sql_ins=mysql_query("INSERT INTO crs_teach_stud
						VALUES(							
							'$course_id',
							'$teacher_id',
							'$student_id'
...
<head>
<title>Select student to add to the course</title>
...
<div id="title" >
<form method="post">
<h2><center>Add Students in a course with a faculty - Choose a Student</center></h2>
<table width="755">
	<tr>
...
?>
		    ...
		    <td><?php echo $row2['type_of_dis'];?></td>
                    ...
                    <td><a href="?tag=tagging3&select=selected&course_id=<?php echo $course_id;?>&teacher_id=<?php echo $teacher_id;?>&student_id=<?php echo $row['enroll'];?>" title="Choose">Choose></a></td>
