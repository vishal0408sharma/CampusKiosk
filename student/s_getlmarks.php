<?php
$enr=$_SESSION["enroll"];
$query = "SELECT * FROM marks_lab where student_id='$enr'";
...
<fieldset><legend><div id="myhd">Marks you Got </div></legend>
		...
		<th  class="filterable table-sortable:default table-sortable" title="Click to sort"  ><div id="dispinfoh">Course</div></th> 
		 <th class="filterable table-sortable:default table-sortable" title="Click to sort"  ><div id="dispinfoh">Marks</div></th> 
		 <th class="filterable table-sortable:default table-sortable" title="Click to sort"  ><div id="dispinfoh">Type</div></th> </tr>
